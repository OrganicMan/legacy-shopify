        ...
        o = function() {
            ...
            for (var f = 0; f < i.length; f++) {
                var l = i[f],
                    ...
                    h = c - l.topSpacing - a,
                    pushedElement = l.stickyWrapper.parent('header').next(),
                    pushedBuffer = l.stickyWrapper.outerHeight(true);
                if (t <= h) {
                    if (l.currentTop !== null) {
                        //pushedElement.css("margin-top", "");  
                    ...
                    if (l.currentTop != p) {
                        l.stickyElement.css("top", p).css("position", "fixed");
                        ...
                        l.currentTop = p
                      	//pushedElement.css("margin-top", pushedBuffer);                     
                    }
                }
            }
        },
